...
import LoginLeftSide from '../componment/LoginLeftSide'
...
const LoginLanding = () => {
  ...
  const  portalsOptions =[
    ...
    },
    {
      ...
      description:"Access your personal information, view schedules, and submit requests.",
      icon:UserIcon
    }
  ]
  return (
...
<div className="space-y-4">
  {portalsOptions.map((portal)=>(
    ...
    <div className="relative z-10 flex items-center justify-between gap-4 sm:gap-5">
      <h3 className="text-lg text-slate-800 group-hover:text-indigo-600 mb-1 tranistion-colors">
{portal.title}
      </h3>
