  ...
  return (
   <form onSubmit={handleSubmit} className='space-y-6 max-w-3xl animate-fade-in'>
    ...
    <div className='card p-5 sm:p-6'>
        ...
        <div className='grid grid-cols-1 sm:grid-col-2 gap-5 text:sm text-slate-700'>
            <div>
               ...
               <div>
                ...
                <input type='date' name='joinDate'required defaultValue={initialData?.joinDate ? new Date (initialData.joinDate).toISOString().split("")[0] : ""} />
            </div>
...
<div className='card p-5 sm:p-6'>
    ...
    <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700'>
        ...
        <div>
                <label className='block mb-2'>Postion</label>
                <input name='position'required defaultValue={initialData?.position} />
            </div>
            <div>
                <label className='block mb-2'>Basic Salary</label>
                <input type="number" name='basicSalary'required defaultValue={initialData?.basicSalary || 0} />
            </div>
            <div>
            ...
            <div>
              ...
              {!isEditMode && (
               ...
               {isEditMode && (
                ...
                <input type="password" name='password'placeholder='Leave blank to keeep currrent' />
            </div> 
              )}
               <div>
